    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{url('suprimeret/'.$Etudiant->id)}}" class="btn btn-danger" onclick="if(confirm('Voulez-vous supprimer cette inscription?')){document.getElementById('form-{{$Etudiant->id}}').submit()}">Supprimer</a>
