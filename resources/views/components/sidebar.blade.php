<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link text-white " href="{{route('entreprise.index')}}">
        
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">receipt_long</i>
          </div>
        
        <span class="nav-link-text ms-1">Gestion des Entreprise</span>
      </a>
    </li>
    

<li class="nav-item">
<a class="nav-link text-white " href="{{route('etud.index')}}">
...
<a class="nav-link text-white " href="{{route('role.index')}}">
  ...
  <span class="nav-link-text ms-1">Gestion de rôle</span>
</a>
</li>
